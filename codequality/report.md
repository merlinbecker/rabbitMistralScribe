...
radar-beta
  ...
  curve p_12_11_8_1k_LOC_["12.11 (8.1k LOC)"]{5, 3, 5, 1, 5, 5}
  curve p_12_11_8_1k_LOC_["12.11 (8.1k LOC)"]{5, 3, 5, 1, 5, 5}
  curve p_12_11_8_1k_LOC_["12.11 (8.1k LOC)"]{5, 3, 5, 1, 5, 5}
  curve p_Aktuell_8_3k_LOC_["Aktuell (8.3k LOC)"]{5, 3, 5, 1, 5, 1}
  max 5
  min 1
```
...
Generated on: 2025-11-12T18:43:44.465Z

> Fenster: offset=1, count=3. LOC relativ: min=8103 → 5, max=8304 → 1. Labels: dd.mm (deutsch) + kurze LOC (k).